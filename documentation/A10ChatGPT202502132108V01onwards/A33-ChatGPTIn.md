...
🔍 Amplitude Analysis - Min: -0.06662, Max: 0.06729, Mean: -0.00098, Median: -0.00037
```
...
update every 2048 samples is an interesting way to regulate the speed of CLI updates

#### thoughts

A simple GUI with only buttons or boxes to input text in the form of a form may be helpful.

No output for the moment to keep it simple.

#### tactics

Make loose points here that may or may not be rigourous, but rather like a brainstorm towards a solution, and progress the small tasks.

#### Priorites

Non-breaking changes.

Make a new file to handle live output.

- Try to create the simplest output possible.
