...
🔍 Amplitude Analysis - Min: -0.00196, Max: 0.00210, Mean: -0.00002, Median: -0.00004
⏳ Program Running: 10 seconds elapsed.
```

### Evalutation

No live audio visual EQ or amplitude level indication

Only 5 secondly Amplitude Analysis

### Next Step

Implement

regularly updating bars reading out level using _ underscore character

Use horizontal read out, as this is easier than atteempting vertical read out in CLI.
