...
Fix: Resolve E0592 (Duplicate new Function) & E0063 (Missing Field is_listening)
Problem
1️⃣ Duplicate Function Definition (E0592)

rust
Copy
Edit
pub fn new() -> Self { ... }
pub fn new() -> Self { ... }  // ❌ Duplicate function definition
There are two identical implementations of new().
2️⃣ Missing Field in Struct Initialization (E0063)
...
The field is_listening is not initialized in new().
Solution
🔹 Remove the duplicate new() function
🔹 Ensure is_listening is initialized in the struct.
...
Expected Fix
✔ Fixes E0592 (Duplicate Function)
