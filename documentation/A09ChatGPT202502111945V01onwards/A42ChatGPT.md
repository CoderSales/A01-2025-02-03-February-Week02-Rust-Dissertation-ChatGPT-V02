...
### Cargo produces the following for the above code (Works)
...
Listening for audio... Press Ctrl+C to stop.
Adjusted Fundamental: 64.60 Hz
Adjusted Fundamental: 150.73 Hz
Adjusted Fundamental: 107.67 Hz
Adjusted Fundamental: 150.73 Hz
Adjusted Fundamental: 172.27 Hz
Adjusted Fundamental: 64.60 Hz
Adjusted Fundamental: 86.13 Hz
Adjusted Fundamental: 107.67 Hz
Adjusted Fundamental: 107.67 Hz

### Issue

Copied only part of code to `.expect("Failed`

and ran this producing the following, which was input to ChatGPT

### Previous Input after incomplete file run
...
fn main() {
    ...
    stream.play().expect("Failed
```

### Latest Chat Output (not used)
...
### Next step was to Run full code from one Chat response before latest
...
### Here was full response, featuring above code in context:
...
### Here is output of full code from Chat response before last Working
